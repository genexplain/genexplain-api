 ...
 *
 */
package com.genexplain.api.app.test;
 ...
 *
 */
@Command(name="test-command-2", description="Just for testing")
public class TestApplicationCommand2 implements ApplicationCommand {

private static int instances = 0;
    
    public TestApplicationCommand2() {
        instances++;
    }
